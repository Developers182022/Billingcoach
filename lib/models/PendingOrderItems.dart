...
/** This is an auto generated class representing the PendingOrderItems type in your schema. */
@immutable
class PendingOrderItems extends Model {
  static const classType = const _PendingOrderItemsModelType();
  final String id;
  ...
  final String? _renting_duration;
  ...
  String? get renting_duration {
    return _renting_duration;
  }
  ...
  const PendingOrderItems._internal({required this.id, user_id, order_id, token_no, item_id, item_unit, item_name, item_price, item_total, item_quantity, renting_duration, check_in_time, Check_out_time, item_status}): _user_id = user_id, _order_id = order_id, _token_no = token_no, _item_id = item_id, _item_unit = item_unit, _item_name = item_name, _item_price = item_price, _item_total = item_total, _item_quantity = item_quantity, _renting_duration = renting_duration, _check_in_time = check_in_time, _Check_out_time = Check_out_time, _item_status = item_status;
  
  factory PendingOrderItems({String? id, String? user_id, String? order_id, String? token_no, String? item_id, String? item_unit, String? item_name, String? item_price, String? item_total, String? item_quantity, String? renting_duration, String? check_in_time, String? Check_out_time, String? item_status}) {
    return PendingOrderItems._internal(
      ...
      renting_duration: renting_duration,
  ...
  bool operator ==(Object other) {
    ...
    return other is PendingOrderItems &&
      id == other.id &&
      ...
      _renting_duration == other._renting_duration &&
  ...
  String toString() {
    ...
    buffer.write("PendingOrderItems {");
    buffer.write("id=" + "$id" + ", ");
    ...
    buffer.write("renting_duration=" + "$_renting_duration" + ", ");
  ...
  PendingOrderItems copyWith({String? id, String? user_id, String? order_id, String? token_no, String? item_id, String? item_unit, String? item_name, String? item_price, String? item_total, String? item_quantity, String? renting_duration, String? check_in_time, String? Check_out_time, String? item_status}) {
    return PendingOrderItems(
      ...
      renting_duration: renting_duration ?? this.renting_duration,
  ...
  PendingOrderItems.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
  ...
  static final QueryField RENTING_DURATION = QueryField(fieldName: "renting_duration");
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "PendingOrderItems";
    modelSchemaDefinition.pluralName = "PendingOrderItems";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.USER_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ORDER_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.TOKEN_NO,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ITEM_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ITEM_UNIT,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ITEM_NAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ITEM_PRICE,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ITEM_TOTAL,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ITEM_QUANTITY,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.RENTING_DURATION,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.CHECK_IN_TIME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.CHECK_OUT_TIME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: PendingOrderItems.ITEM_STATUS,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _PendingOrderItemsModelType extends ModelType<PendingOrderItems> {
  const _PendingOrderItemsModelType();
  
  @override
  PendingOrderItems fromJson(Map<String, dynamic> jsonData) {
    return PendingOrderItems.fromJson(jsonData);
  }
}