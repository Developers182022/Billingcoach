...
/** This is an auto generated class representing the DeletedOrdersItems type in your schema. */
@immutable
class DeletedOrdersItems extends Model {
  static const classType = const _DeletedOrdersItemsModelType();
  final String id;
  ...
  const DeletedOrdersItems._internal({required this.id, user_id, order_id, token_no, item_id, item_name, item_price, item_total, item_unit, rented_duration, item_quantity, check_in_time}): _user_id = user_id, _order_id = order_id, _token_no = token_no, _item_id = item_id, _item_name = item_name, _item_price = item_price, _item_total = item_total, _item_unit = item_unit, _rented_duration = rented_duration, _item_quantity = item_quantity, _check_in_time = check_in_time;
  
  factory DeletedOrdersItems({String? id, String? user_id, String? order_id, String? token_no, String? item_id, String? item_name, String? item_price, String? item_total, String? item_unit, String? rented_duration, String? item_quantity, String? check_in_time}) {
    return DeletedOrdersItems._internal(
  ...
  bool operator ==(Object other) {
    ...
    return other is DeletedOrdersItems &&
      id == other.id &&
  ...
  String toString() {
    ...
    buffer.write("DeletedOrdersItems {");
    buffer.write("id=" + "$id" + ", ");
  ...
  DeletedOrdersItems copyWith({String? id, String? user_id, String? order_id, String? token_no, String? item_id, String? item_name, String? item_price, String? item_total, String? item_unit, String? rented_duration, String? item_quantity, String? check_in_time}) {
    return DeletedOrdersItems(
      id: id ?? this.id,
  ...
  DeletedOrdersItems.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'user_id': _user_id, 'order_id': _order_id, 'token_no': _token_no, 'item_id': _item_id, 'item_name': _item_name, 'item_price': _item_price, 'item_total': _item_total, 'item_unit': _item_unit, 'rented_duration': _rented_duration, 'item_quantity': _item_quantity, 'check_in_time': _check_in_time
  };
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "DeletedOrdersItems";
    modelSchemaDefinition.pluralName = "DeletedOrdersItems";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.USER_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.ORDER_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.TOKEN_NO,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.ITEM_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.ITEM_NAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.ITEM_PRICE,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.ITEM_TOTAL,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.ITEM_UNIT,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.RENTED_DURATION,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.ITEM_QUANTITY,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: DeletedOrdersItems.CHECK_IN_TIME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _DeletedOrdersItemsModelType extends ModelType<DeletedOrdersItems> {
  const _DeletedOrdersItemsModelType();
  
  @override
  DeletedOrdersItems fromJson(Map<String, dynamic> jsonData) {
    return DeletedOrdersItems.fromJson(jsonData);
  }
}