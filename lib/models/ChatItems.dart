...
/** This is an auto generated class representing the ChatItems type in your schema. */
@immutable
class ChatItems extends Model {
  static const classType = const _ChatItemsModelType();
  final String id;
  ...
  const ChatItems._internal({required this.id, user_id, client_id, item_id, item_name, item_quantity, item_price, item_total, renting_duration, check_in_time, item_unit, Check_out_time, item_status, chat_id}): _user_id = user_id, _client_id = client_id, _item_id = item_id, _item_name = item_name, _item_quantity = item_quantity, _item_price = item_price, _item_total = item_total, _renting_duration = renting_duration, _check_in_time = check_in_time, _item_unit = item_unit, _Check_out_time = Check_out_time, _item_status = item_status, _chat_id = chat_id;
  
  factory ChatItems({String? id, String? user_id, String? client_id, String? item_id, String? item_name, String? item_quantity, String? item_price, String? item_total, String? renting_duration, String? check_in_time, String? item_unit, String? Check_out_time, String? item_status, String? chat_id}) {
    return ChatItems._internal(
  ...
  String toString() {
    ...
    buffer.write("chat_id=" + "$_chat_id");
    buffer.write("}");
    
    return buffer.toString();
  }
  
  ChatItems copyWith({String? id, String? user_id, String? client_id, String? item_id, String? item_name, String? item_quantity, String? item_price, String? item_total, String? renting_duration, String? check_in_time, String? item_unit, String? Check_out_time, String? item_status, String? chat_id}) {
    return ChatItems(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'user_id': _user_id, 'client_id': _client_id, 'item_id': _item_id, 'item_name': _item_name, 'item_quantity': _item_quantity, 'item_price': _item_price, 'item_total': _item_total, 'renting_duration': _renting_duration, 'check_in_time': _check_in_time, 'item_unit': _item_unit, 'Check_out_time': _Check_out_time, 'item_status': _item_status, 'chat_id': _chat_id
  };
  ...
  static final QueryField CHAT_ID = QueryField(fieldName: "chat_id");
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "ChatItems";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.USER_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.CLIENT_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.ITEM_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.ITEM_NAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.ITEM_QUANTITY,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.ITEM_PRICE,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.ITEM_TOTAL,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.RENTING_DURATION,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.CHECK_IN_TIME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.ITEM_UNIT,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.CHECK_OUT_TIME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.ITEM_STATUS,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ChatItems.CHAT_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _ChatItemsModelType extends ModelType<ChatItems> {
  const _ChatItemsModelType();
  
  @override
  ChatItems fromJson(Map<String, dynamic> jsonData) {
    return ChatItems.fromJson(jsonData);
  }
}