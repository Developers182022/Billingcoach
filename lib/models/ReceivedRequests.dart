...
/** This is an auto generated class representing the ReceivedRequests type in your schema. */
@immutable
class ReceivedRequests extends Model {
  static const classType = const _ReceivedRequestsModelType();
  final String id;
  ...
  const ReceivedRequests._internal({required this.id, user_id, client_id, client_shop_name, client_name, client_phone_no, date, time}): _user_id = user_id, _client_id = client_id, _client_shop_name = client_shop_name, _client_name = client_name, _client_phone_no = client_phone_no, _date = date, _time = time;
  
  factory ReceivedRequests({String? id, String? user_id, String? client_id, String? client_shop_name, String? client_name, String? client_phone_no, String? date, String? time}) {
    return ReceivedRequests._internal(
  ...
  bool operator ==(Object other) {
    ...
    return other is ReceivedRequests &&
      id == other.id &&
  ...
  ReceivedRequests copyWith({String? id, String? user_id, String? client_id, String? client_shop_name, String? client_name, String? client_phone_no, String? date, String? time}) {
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "ReceivedRequests";
    modelSchemaDefinition.pluralName = "ReceivedRequests";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ReceivedRequests.USER_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ReceivedRequests.CLIENT_ID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ReceivedRequests.CLIENT_SHOP_NAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ReceivedRequests.CLIENT_NAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ReceivedRequests.CLIENT_PHONE_NO,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ReceivedRequests.DATE,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: ReceivedRequests.TIME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _ReceivedRequestsModelType extends ModelType<ReceivedRequests> {
  const _ReceivedRequestsModelType();
  
  @override
  ReceivedRequests fromJson(Map<String, dynamic> jsonData) {
    return ReceivedRequests.fromJson(jsonData);
  }
}